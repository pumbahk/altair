...
def upgrade():
    ...
    op.create_foreign_key("widget_topic_ibfk_3", "widget_topic", "topiccoretag", ["system_tag_id"], ["id"])
    op.add_column('widget_topcontent', sa.Column('system_tag_id', sa.Integer()))
    op.create_foreign_key("widget_topcontent_ibfk_3", "widget_topcontent", "topiccoretag", ["system_tag_id"], ["id"])
    op.add_column('widget_promotion', sa.Column('system_tag_id', sa.Integer()))
...
def downgrade():
    ...
    op.drop_column("widget_promotion", "system_tag_id")
    op.drop_constraint("widget_topcontent_ibfk_3", "widget_topcontent", type="foreignkey")
    op.drop_column("widget_topcontent", "system_tag_id")
    op.drop_constraint("widget_topic_ibfk_3", "widget_topic", type="foreignkey")
