...
@view_config(custom_predicates=(enable_search_function, ), 
             route_name="page_search_input", renderer="altaircms:templates/front/layout/ticketstar.search.input.mako")
...
@view_config(custom_predicates=(enable_search_function, ), 
             route_name="page_search_result", renderer="altaircms:templates/front/layout/ticketstar.search.mako")
...
@view_defaults(custom_predicates=(enable_search_function, ), 
               route_name="page_search_by", renderer="altaircms:templates/front/layout/ticketstar.search.mako")
