...
class GenreAreaSearchForm(Form):
    hokkaido = CheckboxListField(u'北海道・東北',
            ...
            ], default=['all_check', 'hokkaido', 'aomori', 'iwate', 'akita', 'miyagi', 'yamagata', 'fukushima'])
    syutoken = CheckboxListField(u'首都圏・北関東',
            choices=[
            ...
            ], default=['all_check', 'tokyo', 'kanagawa', 'chiba', 'saitama', 'ibaraki', 'tochigi', 'gunma', 'yamanashi'])
    koshinetsu = CheckboxListField(u'甲信越・東海',
            choices=[
                ('all_check', u'全てON/OFF'), ('nagano', u'長野') ,('niigata', u'新潟'), ('gifu', u'岐阜'), ('aichi', u'愛知') ,('mie', u'三重'), ('shizuoka', u'静岡')
            ], default=['all_check', 'nagano', 'niigata', 'gifu', 'aichi', 'mie', 'shizuoka'])
    kinki = CheckboxListField(u'近畿・北陸',
            choices=[
            ...
            ], default=['all_check', 'kyoto', 'osaka', 'hyogo', 'shiga', 'nara', 'wakayama', 'toyama', 'ishikawa', 'fukui'])
    chugoku = CheckboxListField(u'中国・四国',
            choices=[
            ...
            ], default=['all_check', 'hiroshima', 'okayama', 'tottori', 'shimane', 'yamaguchi', 'tokushima', 'kagawa', 'ehime', 'kouchi'])
    kyusyu = CheckboxListField(u'九州・沖縄',
            choices=[
            ...
            ], default=['all_check', 'okinawa', 'fukuoka', 'saga', 'nagasaki', 'kumamoto', 'oita', 'miyazaki', 'kagoshima'])
    genre_id = HiddenField(label='', validators=[Optional()], default="")
    page = HiddenField(validators=[Optional()],default="1")
