...
class Event(Base):
    ...
    subtitle = sa.Column(sa.Unicode, default=u"")
    description = sa.Column(sa.Unicode, default=u"")
    place = sa.Column(sa.Unicode, default=u"")
    inquiry_for = sa.Column(sa.Unicode, default=u"")
