...
def includeme(config):
    ...
    config.add_crud("topic", title="topic", model="..topic.models.Topic", form=".forms.TopicForm", mapper=".mappers.topic_mapper")
    config.add_crud("topcontent", title="topcontent", model="..topcontent.models.Topcontent", form=".forms.TopcontentForm", mapper=".mappers.topcontent_mapper")
