...
<form action="https://api.id.rakuten.co.jp/openid/auth" method="get">
    ...
    <input type="hidden" name="end_point" value="https://127.0.0.1:6543/velruse/openid/auth"/>
    <input type="hidden" name="openid.return_to" value="https://127.0.0.1:6543/velruse/openid/auth"/>
