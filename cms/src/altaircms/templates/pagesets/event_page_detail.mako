...
<div class="row-fluid">
	...
	request.route_path("pageset_list", kind="event")]
    )}
...
<table class="table table-striped">
  ...
  <tr>
    <th class="span2">所属イベント名</th><td><a href="${request.route_path("event",id=pageset.event_id)}">${pageset.event.title}</a></td>
  </tr>
  <tr>
    <th class="span2">URL</th><td>${pageset.url}</td>
  </tr>
  <tr>
    <th class="span2">ページタイプ</th><td>イベント詳細ページ</td>
  </tr>
</table>
