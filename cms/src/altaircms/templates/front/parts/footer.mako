...
<div id="grpRakutenLinkArea">
    ...
    <ul id="grpSpelinlk">
        ...
        <li><a href="/stage">演劇</a></li>
        <li class="grpLast"><a href="/event">イベント・その他</a></li>
    </ul>
    ...
    <dl id="grpKeyword">
        ...
        <dd>
            <ul>
                <li><a href="/">チケット</a></li>
                <li><a href="/stage">演劇</a></li>
                <li><a href="/music">クラシック</a></li>
                <li><a href="/music">コンサート</a></li>
                <li><a href="/sports">野球</a></li>
                <li><a href="/sports">テニス</a></li>
                <li><a href="/sports">サッカー</a></li>
...
<div class="copyright">
    Copyright &copy; 2010-2012 TicketStar Inc. All Rights Reserved.
</div>
