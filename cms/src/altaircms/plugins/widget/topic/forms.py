...
class TopicChoiceForm(form.Form):
    ...
    display_page = fields.BooleanField(id="display_page", label=u"ページに関連したトピックを表示", default=True)
    display_event = fields.BooleanField(id="display_event", label=u"イベントに関連したトピックを表示", default=True)
