...
class FunctionalViewTests(unittest.TestCase):
    create_widget = "/api/widget/flash/create"
    update_widget = "/api/widget/flash/update"
    delete_widget = "/api/widget/flash/delete"
    get_dialog = "/api/widget/flash/dialog"
    ...
    def _makeAsset(self, id=None):
        ...
        return FlashAsset.from_dict({"id": id})
    ...
    def test_create(self):
        ...
        self.assertEquals(FlashWidget.query.first().page.id, page_id)
    ...
    def test_update(self):
        ...
        self.assertEquals(json.loads(res.body), expexted)
        self.assertEquals(FlashWidget.query.count(), 1)
        self.assertEquals(FlashWidget.query.first().asset.id, 2)
