...
class FunctionalViewTests(unittest.TestCase):
    create_widget = "/api/widget/promotion/create"
    update_widget = "/api/widget/promotion/update"
    delete_widget = "/api/widget/promotion/delete"
    get_dialog = "/api/widget/promotion/dialog"
    ...
    def test_create(self):
        ...
        self.assertEquals(PromotionWidget.query.first().page.id, page_id)
    ...
    def test_update(self):
        ...
        self.assertEquals(json.loads(res.body), expexted)
        self.assertEquals(PromotionWidget.query.count(), 1)
        self.assertEquals(PromotionWidget.query.first().content, updated)
