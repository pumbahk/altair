<div class="description">
  ...
  ## todo performancesの表示する数を調整？
    ...
    <div style="TEXT-ALIGN: center">${h.base.nl_to_br(event.subtitle or "")}</div>
    <div style="TEXT-ALIGN: center"><font size="4" face="Arial, Verdana"><b>${h.base.nl_to_br(event.title)}</b></font></div>
	<div style="TEXT-ALIGN: left" align="left">${h.base.nl_to_br(event.description)}</div>
