...
class LinklistWidgetViewTests(WidgetTestSourceMixn, 
                          unittest.TestCase):
    def setUp(self):
        self.config = config
    ...
    def _makeTarget(self, request):
        from altaircms.plugins.widget.linklist.views import LinklistWidgetView
        from altaircms.plugins.widget.linklist.models import LinklistWidgetResource
        request.context = LinklistWidgetResource(request)
        return LinklistWidgetView(request)

    def test_create(self):
        """ test creating LinklistWidget.
        check:
          1. Linklist Widget is created,  successfully.
          2. Linklist Widget and Page object is bounded
        """
        ...
        created = LinklistWidget.query.one()
        self.assertEquals(LinklistWidget.query.count(), 1)
    ...
    def test_update(self):
        ...
        updated = LinklistWidget.query.one()
        self.assertEquals(LinklistWidget.query.count(), 1)
    ...
    def test_delete(self):
        ...
        self.assertEquals(LinklistWidget.query.count(), 0)
