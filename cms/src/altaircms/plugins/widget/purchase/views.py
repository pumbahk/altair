...
class PurchaseWidgetView(object):
    ...
    @view_config(route_name="purchase_widget_update", renderer="json", request_method="POST")
    def update(self):
        return self._create_or_update()

    @view_config(route_name="purchase_widget_delete", renderer="json", request_method="POST")
    def delete(self):
        context = self.request.context
    ...
    @view_config(route_name="purchase_widget_dialog", renderer="altaircms.plugins.widget:purchase/dialog.mako", request_method="GET")
    def dialog(self):
        context = self.request.context
