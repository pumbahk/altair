...
class FunctionalViewTests(unittest.TestCase):
    create_widget = "/api/widget/ticketlist/create"
    update_widget = "/api/widget/ticketlist/update"
    delete_widget = "/api/widget/ticketlist/delete"
    get_dialog = "/api/widget/ticketlist/dialog"
    ...
    def test_create(self):
        ...
        self.assertEquals(TicketlistWidget.query.first().page.id, page_id)
    ...
    def test_update(self):
        ...
        self.assertEquals(json.loads(res.body), expexted)
        self.assertEquals(TicketlistWidget.query.count(), 1)
        # self.assertEquals(TicketlistWidget.query.first().content, updated)
