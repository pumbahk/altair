...
class HSHErrorNumber(Enum):
    ...
    UNKNOWN_TICKET = 20017
    NON_EXISTING_REQUEST_ID = 20018
    MISSING_MANDATORY_FIELD_TO = 20019
    MISSING_MANDATORY_FIELD_BLOCKING_REASON = 20020
    MISSING_MANDATORY_FIELD_BLOCKING_TYPE = 20021
...
class Header(object):
    ...
    """
    def __init__(self, version=None, issuer=None, receiver=None, header_id=None):
        """
        ...
        :param header_id: Unique ID for XML-Data generated by TS
        """
...
class SkidataWebServiceResponse(object):
    ...
    @property
    def errors(self):
        """All Error objects in HSHData by a list"""
        hsh_data = self.hsh_data
