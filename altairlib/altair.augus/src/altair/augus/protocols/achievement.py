...
class AchievementWithNumberedTicketResponseRecord(_AchievementRecord):
    """販売実績応答レコード 整理券フォーマット
    """
    attributes = (
        'event_code',
        'performance_code',
...
class AchievementWithNumberedTicketResponse(AchievementResponse):
    """販売実績応答 整理券フォーマット
    """
    # tkt5866 あえてALLには追加しない。既存処理を考慮し、AugusParser.get_protocolで拾われないようにするため
    record = AchievementWithNumberedTicketResponseRecord
