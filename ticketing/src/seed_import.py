...
try:
    ...
    pass
from altair.app.ticketing.seed.importer import import_seed_data
...
# print commands.getstatusoutput('''pmain  -c development.ini -s altair.app.ticketing.scripts.pmain.seed_import''')
