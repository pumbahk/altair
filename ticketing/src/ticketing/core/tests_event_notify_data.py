...
class GenDataTests(unittest.TestCase):
    ...
    def _callFUT(self, *args, **kwargs):
        from ticketing.events.api import get_cms_data
        return get_cms_data(*args, **kwargs)
        
    def _build_event(self, organization):
        from ticketing.core.models import Event, Performance, Product, SalesSegment, SalesSegmentGroup, Site, Venue, StockType
