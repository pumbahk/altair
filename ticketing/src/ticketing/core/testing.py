class CoreTestMixin(object):
    def setUp(self):
        ...
        from ticketing.payments import plugins as _payment_plugins
        import re
    ...
    def _create_ticket_bundle(self):
        ...
        from ticketing.core.models import TicketBundle, Ticket, TicketFormat
        return TicketBundle(
            tickets=[
    ...
    def _create_order(self, product_quantity_pairs, pdmp=None):
        from ticketing.core.models import Order, OrderedProduct, OrderedProductItem, SeatStatusEnum
