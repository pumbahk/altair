...
def setup_excviews(config):
    config.add_view('.excviews.OutTermSalesView', attr='pc', context='ticketing.cart.exceptions.OutTermSalesException', renderer='base/pc/cart/out_term_sales.html')
    config.add_view('.excviews.OutTermSalesView', attr='mobile', context='ticketing.cart.exceptions.OutTermSalesException', renderer='base/mobile/cart/out_term_sales.html', request_type='altair.mobile.interfaces.IMobileRequest')
