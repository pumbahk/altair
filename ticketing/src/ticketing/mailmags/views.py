...
class MailMagazinesView(BaseView):
    @view_config(route_name='mailmags.index', renderer='ticketing:templates/mailmags/index.html')
    def index(self):
    ...
    @view_config(route_name='mailmags.edit', renderer='ticketing:templates/mailmags/edit.html', request_method='GET')
    def edit(self):
    ...
    @view_config(route_name='mailmags.edit', renderer='ticketing:templates/mailmags/edit.html', request_method='POST')
    def edit_post(self):
    ...
    @view_config(route_name='mailmags.show', renderer='ticketing:templates/mailmags/show.html')
    def show(self):
