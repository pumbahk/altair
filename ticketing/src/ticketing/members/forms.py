...
from ticketing.core.models import UserCredential
...
class LoginUserEditForm(Form):
    auth_identifier = fields.TextField(label=u"名前", validators=[validators.Length(max=255)])
    auth_secret = fields.TextField(label=u"password", validators=[validators.Length(max=255)])
