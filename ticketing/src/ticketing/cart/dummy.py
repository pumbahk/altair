...
def includeme(config):
    ...
    config.add_view(timeout_view, route_name="dummy.timeout", decorator=overwrite_validation, renderer=selectable_renderer("ticketing.cart:templates/%(membership)s/pc/timeout.html"))
    config.add_route("dummy.notfound", "/dummy/notfound")
    config.add_view(notfound_view, route_name="dummy.notfound", decorator=overwrite_validation, renderer=selectable_renderer("ticketing.cart:templates/%(membership)s/pc/errors/notfound.html"))
    config.add_view(notfound_view, route_name="dummy.notfound", request_type='altair.mobile.interfaces.IMobileRequest', decorator=overwrite_validation, renderer=selectable_renderer("ticketing.cart:templates/%(membership)s/mobile/errors/notfound.html"))
