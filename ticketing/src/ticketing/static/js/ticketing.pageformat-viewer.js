(function () {
var __LIBS__ = {};
__LIBS__['_T4QBB912IRO84ES'] = (function (exports) { (function () { 
...
(function ($) {
  var utils = __LIBS__['_T4QBB912IRO84ES'];
  ...
  PageFormatViewer.prototype.load = function PageFormatViewer_load() {
    ...
    self.dataSource(function (data) {
      setTimeout(function () {
        ...
        var paperSize = orientation == 'portrait' ?
          {
            x: utils.convertToUserUnit(data['size'].width),
            y: utils.convertToUserUnit(data['size'].height)
          }:
          {
            x: utils.convertToUserUnit(data['size'].height),
            y: utils.convertToUserUnit(data['size'].width)
          }
        ...
        var printableArea = data['printable_area'];
        var position = {
