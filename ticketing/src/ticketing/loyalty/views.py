...
class PointGrantSettings(BaseView):
    @view_config(route_name='point_grant_settings.index', renderer='ticketing:templates/point_grant_settings/index.html', permission='event_viewer')
    def index(self):
    ...
    @view_config(route_name='point_grant_settings.show', request_method='GET', renderer='ticketing:templates/point_grant_settings/show.html')
    def show(self):
        return { 'point_grant_setting': self.context.point_grant_setting }

    @view_config(route_name='point_grant_settings.new', request_method='GET', renderer='ticketing:templates/point_grant_settings/edit.html', xhr=False)
    @view_config(route_name='point_grant_settings.new', request_method='GET', renderer='ticketing:templates/point_grant_settings/_form.html', xhr=True)
    def new(self):
        return {
            'form': PointGrantSettingForm(context=self.context),
            }

    @view_config(route_name='point_grant_settings.new', request_method='POST', renderer='ticketing:templates/point_grant_settings/edit.html', xhr=False)
    def new_post(self):
    ...
    @view_config(route_name='point_grant_settings.new', request_method='POST', renderer='ticketing:templates/point_grant_settings/_form.html', xhr=True)
    ...
    @view_config(route_name='point_grant_settings.edit', request_method='GET', renderer='ticketing:templates/point_grant_settings/edit.html', xhr=False)
    @view_config(route_name='point_grant_settings.edit', request_method='GET', renderer='ticketing:templates/point_grant_settings/_form.html', xhr=True)
    def edit(self):
        return {
    ...
    @view_config(route_name='point_grant_settings.edit', request_method='POST', renderer='ticketing:templates/point_grant_settings/edit.html', xhr=False)
    def edit_post(self):
    ...
    @view_config(route_name='point_grant_settings.edit', request_method='POST', renderer='ticketing:templates/point_grant_settings/_form.html', xhr=True)
    ...
    @view_config(route_name='point_grant_settings.delete_confirm', renderer='ticketing:templates/point_grant_settings/_delete_confirm.html', xhr=True)
    ...
    @view_config(route_name='point_grant_settings.delete', renderer='ticketing:templates/refresh.html', xhr=True)
    def delete(self):
        point_grant_setting_ids = [long(id) for id in self.request.POST.getall('point_grant_setting_id')]
    ...
    @view_config(route_name='point_grant_settings.products.remove', request_method='POST', renderer='ticketing:templates/refresh.html')
