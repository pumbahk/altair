...
class RouteConfig(object):
    routes = {
        ...
        'discount_code.target_index': u'クーポン・割引コード 適用公演',
        'discount_code.target_confirm': u'クーポン・割引コード 適用公演 変更内容確認',
        'discount_code.target_register': u'クーポン・割引コード 適用公演 変更内容登録',
        'discount_code.target_st_index': u'クーポン・割引コード 適用席種',
