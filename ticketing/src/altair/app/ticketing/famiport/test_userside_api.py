...
from api import create_famiport_venue
...
class FamiPortSyncTest(unittest.TestCase):
    ...
    def test_basiccase2(self):
        ...
        result = create_famiport_venue(self.fm_request, client_code=self.rt_fmtenant.code, userside_id=None, name=venue1.name, name_kana=u'', prefecture=prefecture)
