...
class ConverterTest(unittest.TestCase):
    ...
    def test_text(self):
        self.assertConversionResult(
            ...
            expected=u'<TICKET><b>0.1 S :px U 0 0 m :s "test" x</b><FIXTAG01/><FIXTAG02/><FIXTAG03/><FIXTAG04/><FIXTAG05/><FIXTAG06/></TICKET>')

        self.assertConversionResult(
            input=u'<svg xmlns="http://www.w3.org/2000/svg"><text x="0" y="0">test<tspan>test</tspan></text></svg>',
            expected=u'<TICKET><b>0.1 S :px U 0 0 m :s "testtest" x</b><FIXTAG01/><FIXTAG02/><FIXTAG03/><FIXTAG04/><FIXTAG05/><FIXTAG06/></TICKET>')
        ...
        self.assertConversionResult(
            ...
            expected=u'<TICKET><b>0.1 S :px U 0 0 m :s "test&lt;span style=\\"font-weight:bold\\"&gt;test&lt;/span&gt;" x</b><FIXTAG01/><FIXTAG02/><FIXTAG03/><FIXTAG04/><FIXTAG05/><FIXTAG06/></TICKET>')
    ...
    def test_text_unsupported_font(self):
        self.assertConversionResult(
            ...
            expected=u'<TICKET><b>0.1 S :px U :f16 hc 0 0 m :s "test&lt;span style=\\"font-weight:bold\\"&gt;test&lt;/span&gt;" x</b><FIXTAG01/><FIXTAG02/><FIXTAG03/><FIXTAG04/><FIXTAG05/><FIXTAG06/></TICKET>')
    ...
    def test_text_unsupported_anchor(self):
        self.assertConversionResult(
            ...
            expected=u'<TICKET><b>0.1 S :px U :b hc :f16 hc 0 0 m :s "testtest" x</b><FIXTAG01/><FIXTAG02/><FIXTAG03/><FIXTAG04/><FIXTAG05/><FIXTAG06/></TICKET>')
        self.assertEqual(len(self.dummy_handler.records), 1)
        self.assertEqual(self.dummy_handler.records[0].levelno, logging.WARNING)
    ...
    def test_placeholder(self):
        ...
        self.assertConversionResult(
            ...
            expected=u'<TICKET><b>0.1 S :px U 0 0 m :s "FIXTAG04" xn sxn x</b><FIXTAG01/><FIXTAG02/><FIXTAG03/><FIXTAG04/><FIXTAG05/><FIXTAG06/></TICKET>')
        self.assertConversionResult(
