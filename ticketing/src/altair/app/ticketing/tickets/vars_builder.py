...
class TicketDictBuilder(object):
    ...
    def build_dict_from_performance(self, performance, retval=None):
        ...
        retval.update({
            ...
            u"公演名副題２": performance.subtitle2 if performance.subtitle2 else u"",
            u"公演名副題３": performance.subtitle3 if performance.subtitle3 else u"",
            u"公演名副題４": performance.subtitle4 if performance.subtitle4 else u"",
