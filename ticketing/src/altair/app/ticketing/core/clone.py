    ...
    def visit_payment_delivery_method_pair(self, payment_delivery_method_pair):
        payment_delivery_method_pair_id = self.handler.emit_insert_and_fetch_id(
            PaymentDeliveryMethodPair.__table__,
            {
                ...
                'payment_period_time': payment_delivery_method_pair.payment_period_time,
                ...
                'issuing_interval_time': payment_delivery_method_pair.issuing_interval_time,
                ...
                'issuing_end_in_time': payment_delivery_method_pair.issuing_end_in_time,
