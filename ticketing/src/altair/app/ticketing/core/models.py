...
class PaymentDeliveryMethodPair(Base, BaseModel, WithTimestamp, LogicallyDeleted):
    ...
    payment_period_time = AnnotatedColumn(Time, nullable=True, _a_label=_(u'コンビニでの支払期限日数と対になる時間'))
    ...
    issuing_interval_time = AnnotatedColumn(Integer, nullable=True, _a_label=_(u'コンビニでの発券が可能となるまでの日数と対になる時間'))
    ...
    issuing_end_in_time = AnnotatedColumn(Integer, nullable=True, _a_label=_(u'コンビニでの発券終了までの日数と対になる時間'))
