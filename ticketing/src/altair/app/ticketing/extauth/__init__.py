...
def webapp_main(global_config, **local_config):
    ...
    config.add_route('extauth.rakuten.index', '/{subtype}/', traverse='/{subtype}')
    config.add_route('extauth.rakuten.login', '/{subtype}/login', traverse='/{subtype}')
    config.scan('.views')
...
def api_main(global_config, **local_config):
    ...
    config.include('.request')
    config.include(setup_oauth_provider)
    config.add_route('extauth.api.oauth_access_token', '/token')
