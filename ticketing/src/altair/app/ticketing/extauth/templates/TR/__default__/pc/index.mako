        ...
        <section>
            ...
            <div class="login-box">
                ...
                % for provider in oauth_service_providers:
                    <a href="${_context.route_path('extauth.fanclub.entry', _query=dict(service_provider_name=provider.name))}" class="btn">${provider.display_name}<span style="font-size:80%">でログイン</span></a>
                % endfor
                % endif
                </p>
            </div>
