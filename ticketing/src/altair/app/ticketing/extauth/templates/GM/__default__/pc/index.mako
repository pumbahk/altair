...
<div class="main">
    ...
    <div class="login-area clearfix">
        <div id="member-login-box" class="login-box login-box-2">
            <dl>
                <dt class="login-name">会員の方はこちら</dt>
                <dd><a href="${_context.route_path('extauth.fanclub.entry')}" class="btn-login">会員IDでログインする</a></dd>
            </dl>
        </div>
