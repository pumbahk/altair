        ...
        <div class="inner">
          <ul class="info-list-box">
            <li class="info-list">
              ...
              <p class="info-txt">■会員の方も、受付番号（REから始まる12ケタ）から確認することができます。<br>■会員ID・パスワードは半角でご入力ください。
              <br>※アプリでこのページをご覧いただいている方で、現在利用中の楽天IDとは異なる楽天IDで購入済みのチケットを表示されたい場合は、アプリの「MORE」メニューから一度ログアウトをし、ログインをしなおしてください。</p>
            </li>
            <li class="info-list">
