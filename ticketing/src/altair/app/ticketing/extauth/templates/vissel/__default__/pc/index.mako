...
<p class="clear tar">&raquo; <a href="${_context.route_path('extauth.login', _query=dict(member_set=member_set.name))}"><span>シーズンシートオーナー優待販売・各種IDをお持ちの方はこちらから</span></a></p>
</div>
</dd>
</dl>
</div>
