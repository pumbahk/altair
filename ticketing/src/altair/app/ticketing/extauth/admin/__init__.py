...
def main(global_config, **local_config):
    ...
    config.add_route('hosts.new', '/organizations/{id}/new_host')
    config.add_route('service_providers.index', '/service_providers', request_method='GET')
    config.add_route('service_providers.new', '/service_providers/new')
    config.add_route('service_providers.edit', '/service_providers/{id}/edit')
    config.scan('.views')
