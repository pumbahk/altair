...
class SalesSegments(BaseView):
    ...
    def new_post(self):
        ...
        sales_segment = merge_session_with_post(sales_segment, f.data, excludes={'order_limit', 'max_quantity_per_user', 'disp_orderreview', 'display_seat_no', 'disp_agreement', 'agreement_body'})
