...
class AugusTable(_TableBase):
    EXT_HEADER_GETTER = collections.OrderedDict((
        ...
        ('augus_venue_name', lambda ag_seat: _sjis(getattr(getattr(ag_seat, 'augus_venue', ''), 'name', ''))),
        ('augus_seat_area_name', lambda ag_seat: _sjis(getattr(ag_seat, 'area_name', ''))),
        ('augus_seat_info_name', lambda ag_seat: _sjis(getattr(ag_seat, 'info_name', ''))),
        ('augus_seat_doorway_name', lambda ag_seat: _sjis(getattr(ag_seat, 'doorway_name', ''))),
        ...
        ('augus_seat_block', lambda ag_seat: getattr(ag_seat, 'block', '')),
        ('augus_seat_coordy', lambda ag_seat: getattr(ag_seat, 'coordy', '')),
        ('augus_seat_coordx', lambda ag_seat: getattr(ag_seat, 'coordx', '')),
        ('augus_seat_coordy_whole', lambda ag_seat: getattr(ag_seat, 'coordy_whole', '')),
        ('augus_seat_coordx_whole', lambda ag_seat:getattr(ag_seat, 'coordx_whole', '')),
...
class AugusTableWithNumberedTicket(AugusTable):
    EXT_HEADER_GETTER = collections.OrderedDict((
        ('augus_venue_code', lambda ag_seat: getattr(getattr(ag_seat, 'augus_venue', ''), 'code', '')),
        ('augus_venue_name', lambda ag_seat: _sjis(getattr(getattr(ag_seat, 'augus_venue', ''), 'name', ''))),
        ('augus_seat_area_name', lambda ag_seat: _sjis(getattr(ag_seat, 'area_name', ''))),
        ...
        ('augus_seat_column', lambda ag_seat: _sjis(getattr(ag_seat, 'column', ''))),
        ('augus_seat_num', lambda ag_seat: _sjis(getattr(ag_seat, 'num', ''))),
        ('augus_seat_ticket_number', lambda ag_seat: getattr(ag_seat, 'ticket_number', '')),
        ('augus_seat_block', lambda ag_seat: getattr(ag_seat, 'block', '')),
        ('augus_seat_coordy', lambda ag_seat: getattr(ag_seat, 'coordy', '')),
        ('augus_seat_coordx', lambda ag_seat: getattr(ag_seat, 'coordx', '')),
        ('augus_seat_coordy_whole', lambda ag_seat: getattr(ag_seat, 'coordy_whole', '')),
...
class AugusCSVEditor(_CSVEditorBase):
    ...
    def __init__(self, account=None):
        if account and account.use_numbered_ticket_format:
            self._table = AugusTableWithNumberedTicket
        else:
            self._table = AugusTable
