...
var ApiConst = (function () {
    ...
    //DNSエラー
    ApiConst.SERVER_DNS_ERROR = 'server dns error';
    //500系エラー
    ApiConst.INTERNAL_SERVER_ERROR = 'Internal Server Error';
    ApiConst.SERVICE_UNAVAILABLE = 'Service Unavailable';
    return ApiConst;
}());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_29_ng_inline_svg__ = __webpack_require__("../../../../ng-inline-svg/lib/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_29_ng_inline_svg___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_29_ng_inline_svg__);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_31_ng2_loading_animate__ = __webpack_require__("../../../../ng2-loading-animate/ng2-loading-animate.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_31_ng2_loading_animate___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_31_ng2_loading_animate__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_32_ng2_nouislider__ = __webpack_require__("../../../../ng2-nouislider/src/nouislider.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_32_ng2_nouislider___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_32_ng2_nouislider__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_33_angular2_logger_core__ = __webpack_require__("../../../../angular2-logger/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_33_angular2_logger_core___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_33_angular2_logger_core__);
...
var routes = [
    { path: 'performances/:performance_id', component: __WEBPACK_IMPORTED_MODULE_6__reserve_by_seat_reserve_by_seat_component__["a" /* ReserveBySeatComponent */] },
...
var AppModule = (function () {
    function AppModule(logger) {
        ...
        this.logger.level = __WEBPACK_IMPORTED_MODULE_34__environments_environment__["a" /* environment */].logger.level;
    }
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
            ...
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_29_ng_inline_svg__["InlineSVGModule"],
                __WEBPACK_IMPORTED_MODULE_0__angular_platform_browser__["BrowserModule"], __WEBPACK_IMPORTED_MODULE_2__angular_forms__["FormsModule"], __WEBPACK_IMPORTED_MODULE_3__angular_http__["HttpModule"], __WEBPACK_IMPORTED_MODULE_30_primeng_primeng__["InputTextModule"], __WEBPACK_IMPORTED_MODULE_30_primeng_primeng__["ButtonModule"], __WEBPACK_IMPORTED_MODULE_30_primeng_primeng__["DialogModule"], __WEBPACK_IMPORTED_MODULE_30_primeng_primeng__["DropdownModule"],
                __WEBPACK_IMPORTED_MODULE_31_ng2_loading_animate__["LoadingAnimateModule"].forRoot(),
                __WEBPACK_IMPORTED_MODULE_4__angular_router__["RouterModule"].forRoot(routes),
                __WEBPACK_IMPORTED_MODULE_32_ng2_nouislider__["NouisliderModule"]
            ],
            providers: [
                __WEBPACK_IMPORTED_MODULE_33_angular2_logger_core__["Logger"],
                __WEBPACK_IMPORTED_MODULE_31_ng2_loading_animate__["LoadingAnimateService"],
        ...
        __metadata('design:paramtypes', [(typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_33_angular2_logger_core__["Logger"] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_33_angular2_logger_core__["Logger"]) === 'function' && _a) || Object])
    ], AppModule);
    return AppModule;
    var _a;
}());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__shared_services_animation_enable_service__ = __webpack_require__("../../../../../src/app/shared/services/animation-enable.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ApiCommonErrorComponent = (function () {
    function ApiCommonErrorComponent(errorModalDataService, animationEnableService) {
    ...
    ApiCommonErrorComponent = __decorate([
        ...
        __metadata('design:paramtypes', [(typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__shared_services_error_modal_data_service__["a" /* ErrorModalDataService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_1__shared_services_error_modal_data_service__["a" /* ErrorModalDataService */]) === 'function' && _a) || Object, (typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_2__shared_services_animation_enable_service__["a" /* AnimationEnableService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_2__shared_services_animation_enable_service__["a" /* AnimationEnableService */]) === 'function' && _b) || Object])
...
var ReserveByQuantityComponent = (function () {
    ...
    ReserveByQuantityComponent.prototype.modalSizeObtained = function () {
        var windowHeight = __WEBPACK_IMPORTED_MODULE_13_jquery__(window).height();
        var headHeight = __WEBPACK_IMPORTED_MODULE_13_jquery__('header').height() + __WEBPACK_IMPORTED_MODULE_13_jquery__('.headArea').height();
        var footerHeight = 96;
        //スクロール領域のサイズ
        var scrollSize = 0;
        //マップ領域のサイズ
        ...
        setTimeout(function () {
            __WEBPACK_IMPORTED_MODULE_13_jquery__('.modalWindow-quantity').css({
                'height': scrollSize
            });
            __WEBPACK_IMPORTED_MODULE_13_jquery__('#venue-quentity').css({
                'height': mapSize,
            });
            __WEBPACK_IMPORTED_MODULE_13_jquery__('#venue-quentity').children("svg").css({
                'height': mapSize,
            });
        }, 0);
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_router__ = __webpack_require__("../../../router/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__shared_services_performances_service__ = __webpack_require__("../../../../../src/app/shared/services/performances.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__shared_services_error_modal_data_service__ = __webpack_require__("../../../../../src/app/shared/services/error-modal-data.service.ts");
...
var EventinfoComponent = (function () {
     ...
     * コンストラクタ
     */
    function EventinfoComponent(route, router, performancesService, errorModalDataService, AppConstService, _logger) {
        this.route = route;
        this.router = router;
    ...
    EventinfoComponent.prototype.ngOnInit = function () {
        ...
        this.route.params.subscribe(function (params) {
            if (params && params['performance_id']) {
                //パラメーター切り出し
                _this.performanceId = +params['performance_id'];
                _this.performancesService.getPerformance(_this.performanceId).subscribe(function (response) {
                    _this._logger.debug("get Performance(#" + _this.performanceId + ") success", response);
                    _this.performance = response.data.performance;
                    _this.performanceName = _this.performance.performance_name;
                    _this.venueName = _this.performance.venue_name;
    ...
    EventinfoComponent.prototype.onClick = function () {
        location.href = "" + __WEBPACK_IMPORTED_MODULE_4__app_constants__["b" /* AppConstService */].PAGE_URL.TOP;
    };
    EventinfoComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            providers: [__WEBPACK_IMPORTED_MODULE_4__app_constants__["b" /* AppConstService */]],
        ...
        __metadata('design:paramtypes', [(typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["ActivatedRoute"] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_1__angular_router__["ActivatedRoute"]) === 'function' && _a) || Object, (typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["Router"] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_1__angular_router__["Router"]) === 'function' && _b) || Object, (typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_2__shared_services_performances_service__["a" /* PerformancesService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_2__shared_services_performances_service__["a" /* PerformancesService */]) === 'function' && _c) || Object, (typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_3__shared_services_error_modal_data_service__["a" /* ErrorModalDataService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_3__shared_services_error_modal_data_service__["a" /* ErrorModalDataService */]) === 'function' && _d) || Object, (typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_4__app_constants__["b" /* AppConstService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_4__app_constants__["b" /* AppConstService */]) === 'function' && _e) || Object, (typeof (_f = typeof __WEBPACK_IMPORTED_MODULE_5_angular2_logger_core__["Logger"] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_5_angular2_logger_core__["Logger"]) === 'function' && _f) || Object])
    ], EventinfoComponent);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__shared_services_performances_service__ = __webpack_require__("../../../../../src/app/shared/services/performances.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__shared_services_seats_service__ = __webpack_require__("../../../../../src/app/shared/services/seats.service.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__shared_services_stock_type_data_service__ = __webpack_require__("../../../../../src/app/shared/services/stock-type-data.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__shared_services_error_modal_data_service__ = __webpack_require__("../../../../../src/app/shared/services/error-modal-data.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__shared_services_animation_enable_service__ = __webpack_require__("../../../../../src/app/shared/services/animation-enable.service.ts");
...
var FilterComponent = (function () {
    function FilterComponent(performancesService, seats, route, stockTypesService, errorModalDataService, animationEnableService, stockTypeDataService, _logger) {
        ...
        this.seats = seats;
        this.route = route;
        this.stockTypesService = stockTypesService;
        this.errorModalDataService = errorModalDataService;
        this.animationEnableService = animationEnableService;
        this.stockTypeDataService = stockTypeDataService;
        this._logger = _logger;
        ...
        this.route.params.subscribe(function (params) {
            if (params && params['performance_id']) {
                ...
                _this.performancesService.getPerformance(_this.performanceId).subscribe(function (response) {
                    ...
                    _this.salesSegmentId = _this.performance.sales_segments[0].sales_segment_id;
                    //席種情報検索
    ...
    FilterComponent = __decorate([
        ...
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Injectable"])(), 
        __metadata('design:paramtypes', [(typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_3__shared_services_performances_service__["a" /* PerformancesService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_3__shared_services_performances_service__["a" /* PerformancesService */]) === 'function' && _a) || Object, (typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_4__shared_services_seats_service__["a" /* SeatsService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_4__shared_services_seats_service__["a" /* SeatsService */]) === 'function' && _b) || Object, (typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["ActivatedRoute"] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_1__angular_router__["ActivatedRoute"]) === 'function' && _c) || Object, (typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_5__shared_services_stock_types_service__["a" /* StockTypesService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_5__shared_services_stock_types_service__["a" /* StockTypesService */]) === 'function' && _d) || Object, (typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_7__shared_services_error_modal_data_service__["a" /* ErrorModalDataService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_7__shared_services_error_modal_data_service__["a" /* ErrorModalDataService */]) === 'function' && _e) || Object, (typeof (_f = typeof __WEBPACK_IMPORTED_MODULE_8__shared_services_animation_enable_service__["a" /* AnimationEnableService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_8__shared_services_animation_enable_service__["a" /* AnimationEnableService */]) === 'function' && _f) || Object, (typeof (_g = typeof __WEBPACK_IMPORTED_MODULE_6__shared_services_stock_type_data_service__["a" /* StockTypeDataService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_6__shared_services_stock_type_data_service__["a" /* StockTypeDataService */]) === 'function' && _g) || Object, (typeof (_h = typeof __WEBPACK_IMPORTED_MODULE_11_angular2_logger_core__["Logger"] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_11_angular2_logger_core__["Logger"]) === 'function' && _h) || Object])
    ], FilterComponent);
    ...
    ReserveBySeatComponent.prototype.ngOnInit = function () {
            ...
            if (windowWidth <= windowSm) {
                ...
                __WEBPACK_IMPORTED_MODULE_3_jquery__(function () {
                    function heightSetting() {
                        ...
                        else if (__WEBPACK_IMPORTED_MODULE_3_jquery__('#choiceSeatArea').length) {
                            minus = 280;
                        }
                        else {
                            minus = 149;
                        ...
                        var windowH = __WEBPACK_IMPORTED_MODULE_3_jquery__(window).height();
                ...
                __WEBPACK_IMPORTED_MODULE_3_jquery__(function () {
                    ...
                    function heightSetting() {
                        ...
                        mainH = windowH - minus;
                        that.mapAreaLeftH = mainH;
                        __WEBPACK_IMPORTED_MODULE_3_jquery__('#' + mainID + ',#mapImgBox svg').height(mainH + 'px');
                    }
                    heightSetting();
                    __WEBPACK_IMPORTED_MODULE_3_jquery__(window).resize(function () {
                        heightSetting();
        ...
        __WEBPACK_IMPORTED_MODULE_3_jquery__(function () {
            ...
            __WEBPACK_IMPORTED_MODULE_3_jquery__("#mapAreaRight").on("click", ".acd dt", function () {
                if (__WEBPACK_IMPORTED_MODULE_3_jquery__(this).children().attr('class') != "close") {
...
module.exports = "<div id=\"choiceSeatArea\" class=\"choiceSeatArea\" *ngIf=\"seatListDisply\">\r\n    <p class=\"choiceSeatTtl\">席種を選択</p>\r\n    <dl class=\"acd\">\r\n        <div *ngIf=\"searchResultFlag\">条件に一致するチケットがありませんでした。</div>\r\n        <div *ngIf=\"!searchResultFlag\">\r\n            <div *ngFor=\"let stockType of makeStockTypes\">\r\n                <dt><span class=\"{{stockStatus(stockTypesArr[stockType.stock_type_id][1])}}\"><span></span></span><div class=\"listText\">{{stockTypesArr[stockType.stock_type_id][0]}}</div></dt>\r\n                <dd style=\"display:none\">\r\n                    <div *ngIf=\"stockType.is_quantity_only\" class=\"buy\"><button class=\"\" type=\"button\" (click)=\"onAutoClick(stockType.stock_type_id)\">この席種を購入</button></div>\r\n                    <div *ngIf=\"!stockType.is_quantity_only\"><button class=\"\" type=\"button\" (click)=\"onSelectClick(stockTypesArr[stockType.stock_type_id][0])\">座席を選んで購入</button><button class=\"\" type=\"button\" (click)=\"onAutoClick(stockType.stock_type_id)\">おまかせで購入</button></div>\r\n                </dd>\r\n            </div>\r\n        </div>\r\n    </dl>\r\n</div>"
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__shared_services_stock_types_service__ = __webpack_require__("../../../../../src/app/shared/services/stock-types.service.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__shared_services_performances_service__ = __webpack_require__("../../../../../src/app/shared/services/performances.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__shared_services_error_modal_data_service__ = __webpack_require__("../../../../../src/app/shared/services/error-modal-data.service.ts");
...
var SeatlistComponent = (function () {
    function SeatlistComponent(route, reserveByQuantity, stockTypeDataService, performancesService, _logger, errorModalDataService, stockTypesService) {
        this.route = route;
     ...
     */
    SeatlistComponent.prototype.makeStockTypeArr = function (stockTypes, seatStockTypes) {
        var array = {};
        //席種情報検索ベースに名前とステータスを配列に詰める
        for (var x in this.stockTypes) {
            array[stockTypes[x].stock_type_id] = [];
            array[stockTypes[x].stock_type_id].push(stockTypes[x].stock_type_name);
            for (var y in seatStockTypes) {
     ...
     * @return {IStockType[]}
     */
    SeatlistComponent.prototype.divideList = function (stockTypes) {
        var _this = this;
        var divideStockTypes;
        divideStockTypes = [];
        stockTypes.forEach(function (value, key) {
  ...
  */
    SeatlistComponent.prototype.onAutoClick = function (stockTypeId) {
        __WEBPACK_IMPORTED_MODULE_8_jquery__('html').css({
            'height': "",
            'overflow-y': "hidden"
        });
        __WEBPACK_IMPORTED_MODULE_8_jquery__('body').css({
            'height': "",
            'overflow-y': "hidden"
        });
        __WEBPACK_IMPORTED_MODULE_8_jquery__('body').scrollTop(0);
   ...
   */
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])('isInitialEnd'), 
        __metadata('design:type', Boolean)
    ], SeatlistComponent.prototype, "isInitialEnd", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Output"])(), 
        __metadata('design:type', Object)
    ...
    SeatlistComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            providers: [__WEBPACK_IMPORTED_MODULE_1__reserve_by_seat_filter_filter_component__["a" /* FilterComponent */], __WEBPACK_IMPORTED_MODULE_2__reserve_by_quantity_reserve_by_quantity_component__["a" /* ReserveByQuantityComponent */]],
        ...
        __metadata('design:paramtypes', [(typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_7__angular_router__["ActivatedRoute"] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_7__angular_router__["ActivatedRoute"]) === 'function' && _c) || Object, (typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_2__reserve_by_quantity_reserve_by_quantity_component__["a" /* ReserveByQuantityComponent */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_2__reserve_by_quantity_reserve_by_quantity_component__["a" /* ReserveByQuantityComponent */]) === 'function' && _d) || Object, (typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_4__shared_services_stock_type_data_service__["a" /* StockTypeDataService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_4__shared_services_stock_type_data_service__["a" /* StockTypeDataService */]) === 'function' && _e) || Object, (typeof (_f = typeof __WEBPACK_IMPORTED_MODULE_5__shared_services_performances_service__["a" /* PerformancesService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_5__shared_services_performances_service__["a" /* PerformancesService */]) === 'function' && _f) || Object, (typeof (_g = typeof __WEBPACK_IMPORTED_MODULE_9_angular2_logger_core__["Logger"] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_9_angular2_logger_core__["Logger"]) === 'function' && _g) || Object, (typeof (_h = typeof __WEBPACK_IMPORTED_MODULE_6__shared_services_error_modal_data_service__["a" /* ErrorModalDataService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_6__shared_services_error_modal_data_service__["a" /* ErrorModalDataService */]) === 'function' && _h) || Object, (typeof (_j = typeof __WEBPACK_IMPORTED_MODULE_3__shared_services_stock_types_service__["a" /* StockTypesService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_3__shared_services_stock_types_service__["a" /* StockTypesService */]) === 'function' && _j) || Object])
    ], SeatlistComponent);
...
var VenuemapComponent = (function () {
    function VenuemapComponent(el, route, performancesService, seatStatus, stockTypesService, QuentityChecks, router, reserveByQuantity, stockTypeDataService, errorModalDataService, animationEnableService, countSelectService, smartPhoneCheckService, _logger) {
        this.el = el;
        this.route = route;
        this.performancesService = performancesService;
        this.seatStatus = seatStatus;
    ...
    VenuemapComponent.prototype.ngOnInit = function () {
        ...
        this.route.params.subscribe(function (params) {
            if (params && params['performance_id']) {
                ...
                _this.performancesService.getPerformance(_this.performanceId).subscribe(function (response) {
                    _this._logger.debug("get Performance(#" + _this.performanceId + ") success", response);
                    var performanceRes = response;
                    _this.event = performanceRes.data.event;
                    ...
                    var selesSegmentId = _this.salesSegments[0].sales_segment_id;
                    _this.stockTypesService.getStockTypesAll(_this.performanceId, selesSegmentId)
                        .subscribe(function (response) {
                        _this._logger.debug("get StockTypesAll(#" + _this.performanceId + ") success", response);
                        var stockTypes = response.data.stock_types;
                        for (var i = 0, len = stockTypes.length; i < len; i++) {
                            if (!_this.smartPhoneCheckService.isSmartPhone()) {
                                ...
                                var minPrice = void 0;
                                var maxPrice = void 0;
                                for (var j = 0, len_1 = stockTypes[i].products.length; j < len_1; j++) {
                                    var price = +stockTypes[i].products[j].price;
                                ...
                                //tooltip用のデータを作成する
                                _this.tooltipStockType[stockTypes[i].stock_type_id] = {
                                    name: stockTypes[i].stock_type_name,
                                    min: minPrice,
                                    max: maxPrice,
                                    region: []
                                };
                                for (var j = 0, len_2 = stockTypes[i].regions.length; j < len_2; j++) {
                                    _this.tooltipStockType[stockTypes[i].stock_type_id].region.push(stockTypes[i].regions[j]);
                                }
                            }
                            if (stockTypes[i].is_quantity_only) {
                        ...
                        _this.isRegionObtained = true;
                        _this.stockTypesService.findStockTypesByPerformanceId(_this.performanceId).subscribe(function (response) {
                            _this._logger.debug("findStockTypesByPerformanceId(#" + _this.performanceId + ") success", response);
                            _this.stockType = response.data.stock_types;
                        }, function (error) {
                            _this._logger.error('findStockTypesByPerformanceId(#${this.performanceId}) error', error);
                        });
                        (function (error) {
        ...
        __WEBPACK_IMPORTED_MODULE_13_jquery__(window).resize(function () {
            ...
            resizeTimer = setTimeout(function () {
                ...
                if (that.originalViewBox && that.mapAreaLeftH != 0) {
                    ...
                    //viewboxの調整
                    var resizeViewBox = _this.getPresentViewBox(); //調整後のviewbox
                    //viewboxがとれたら処理を行う
                    if (resizeViewBox) {
                        ...
                        if (parseFloat(_this.displayViewBox[0]) > parseFloat(resizeViewBox[0])) {
                            _this.mapHome();
                        }
                        else if (parseFloat(_this.displayViewBox[1]) > parseFloat(resizeViewBox[1])) {
                            _this.mapHome();
                        }
                        else if (parseFloat(_this.displayViewBox[0]) + parseFloat(_this.displayViewBox[2]) < parseFloat(resizeViewBox[0]) + parseFloat(resizeViewBox[2])) {
                            _this.mapHome();
                        }
...
var ApiBase = (function (_super) {
    ...
    ApiBase.prototype.handleError = function (error) {
        ...
        if (error instanceof __WEBPACK_IMPORTED_MODULE_1__angular_http__["Response"]) {
            ...
            if (status == 0) {
                errMsg = "" + __WEBPACK_IMPORTED_MODULE_5__app_constants__["a" /* ApiConst */].SERVER_DNS_ERROR;
            }
            else if (status == 500) {
                errMsg = "" + __WEBPACK_IMPORTED_MODULE_5__app_constants__["a" /* ApiConst */].INTERNAL_SERVER_ERROR;
            }
            else if (status == 503) {
                errMsg = "" + __WEBPACK_IMPORTED_MODULE_5__app_constants__["a" /* ApiConst */].SERVICE_UNAVAILABLE;
            }
            else {
    ...
    ApiBase.prototype.callErrorModal = function (errMsg) {
        if (errMsg == "" + __WEBPACK_IMPORTED_MODULE_5__app_constants__["a" /* ApiConst */].TIMEOUT || errMsg == "" + __WEBPACK_IMPORTED_MODULE_5__app_constants__["a" /* ApiConst */].SERVER_DNS_ERROR) {
            this.errorModalDataService.sendToErrorModal('通信エラー発生', 'インターネットに未接続または通信が不安定な可能性があります。通信環境の良いところで操作をやり直すかページを再読込してください。');
        }
        else if (errMsg == "" + __WEBPACK_IMPORTED_MODULE_5__app_constants__["a" /* ApiConst */].INTERNAL_SERVER_ERROR) {
            this.errorModalDataService.sendToErrorModal('サーバーエラー発生', '予期しないエラーが発生しました。操作をやり直すかページを再読込してください。');
        }
        else if (errMsg == "" + __WEBPACK_IMPORTED_MODULE_5__app_constants__["a" /* ApiConst */].SERVICE_UNAVAILABLE) {
