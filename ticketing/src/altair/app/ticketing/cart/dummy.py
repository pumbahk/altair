...
from .rendering import selectable_renderer_for_dummy
...
def includeme(config):
    ...
    config.add_view(payment_view, route_name='dummy.cart.payment', request_method="GET", decorator=overwrite_validation,
    ...
    config.add_view(payment_view, route_name='dummy.cart.payment', request_type='altair.mobile.interfaces.IMobileRequest', request_method="GET",
                    decorator=overwrite_validation, renderer=selectable_renderer_for_dummy("payment.html"))
    ...
    config.add_view(confirm_view, route_name='dummy.payment.confirm', request_method="GET",
                    decorator=overwrite_validation, renderer=selectable_renderer_for_dummy("confirm.html"))
    config.add_view(confirm_view, route_name='dummy.payment.confirm', request_type='altair.mobile.interfaces.IMobileRequest',
                    request_method="GET", decorator=overwrite_validation, renderer=selectable_renderer_for_dummy("confirm.html"))
    ...
    config.add_view(complete_view, route_name='dummy.payment.complete',
                    request_method="GET", decorator=overwrite_validation,
                    renderer=selectable_renderer_for_dummy("completion.html"))
    ...
    config.add_view(timeout_view, route_name="dummy.timeout", decorator=overwrite_validation,
                    renderer=selectable_renderer_for_dummy("errors/timeout.html"))

    # not found
    config.add_route("dummy.notfound", "/dummy/notfound")
    config.add_view(notfound_view, route_name="dummy.notfound", decorator=overwrite_validation,
    ...
    config.add_view(notfound_view, route_name="dummy.notfound", request_type='altair.mobile.interfaces.IMobileRequest',
                    decorator=overwrite_validation,
                    renderer=selectable_renderer_for_dummy("errors/notfound.html"))
