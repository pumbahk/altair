...
from altair.app.ticketing.cart.exceptions import NoCartError, InvalidCSRFTokenException
...
class CompleteView(_CompleteView):
    ...
    def __call__(self):
        ...
        if payment_delivery_plugin is not None:
            ...
            cart.order = order #xxxx: see: altair.app.ticketing.payments.payment:Payment.call_payment, altair.app.ticketing.payments.plugins.qr:QRTicketDeliveryPlugin.finish
            assert order
            DBSession.add(order)
