# encoding: utf-8
from altair.app.ticketing.seed.fixtures import FixtureBuilder, STOCK_TYPE_TYPE_OTHER, STOCK_TYPE_TYPE_SEAT
from altair.app.ticketing.seed.data import payment_method_names, delivery_method_names, payment_delivery_method_pair_matrix, bank_pairs, role_seeds, operator_seeds
