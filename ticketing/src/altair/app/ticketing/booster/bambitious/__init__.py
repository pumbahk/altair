...
def setup_booster_settings(config):
    ...
    config.add_layout(".layout.Layout", "altair.app.ticketing.booster.bambitious:templates/base.html") #xxx:
    config.add_panel("altair.app.ticketing.booster.panels.input_form", "input_form", renderer="altair.app.ticketing.booster.bambitious:templates/carts/_form.html")
    config.add_panel("altair.app.ticketing.booster.panels.input_form", "mobile_input_form", renderer="altair.app.ticketing.booster.bambitious:templates/carts_mobile/_form.html")
    config.add_panel("altair.app.ticketing.booster.panels.review_additional_messages", "review.additional_messags", renderer="altair.app.ticketing.booster.bambitious:templates/order_review/_additional_messages.html")
    config.add_panel("altair.app.ticketing.booster.panels.review_additional_messages", "review_mobile.additional_messags", renderer="altair.app.ticketing.booster.bambitious:templates/order_review_mobile/_additional_messages.html")
