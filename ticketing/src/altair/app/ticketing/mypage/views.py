...
import altair.app.ticketing.payments.plugins.qr
...
class MyPageView(object):
    ...
    def order(self):
        ...
        tickets = None
        if order.payment_delivery_pair.delivery_method.delivery_plugin_id == altair.app.ticketing.payments.plugins.qr.DELIVERY_PLUGIN_ID:
            """QRコード発行の場合"""
