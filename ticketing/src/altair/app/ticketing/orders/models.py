...
class Order(Base, BaseModel, WithTimestamp, LogicallyDeleted):
    ...
    def get_order_attribute_pair_pairs(self, request, include_undefined_items=False, mode=None):
        from .api import get_order_attribute_pair_pairs
        return get_order_attribute_pair_pairs(request, self, include_undefined_items=include_undefined_items, mode=mode)
