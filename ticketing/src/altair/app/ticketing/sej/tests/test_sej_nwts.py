...
class PythonNWTSUploaderTest(unittest.TestCase):
    ...
    def test_nwts_template(self):
        ...
        self.assertEqual(self.dummy_server.request.body, "60022000600220SEIT020U\x0a\0\0\0\0\0\0\0" "1234567890")
    ...
    def test_nwts_refund(self):
        ...
        self.assertEqual(self.dummy_server.request.body, "60022000600220SDMT010U\x0a\0\0\0\0\0\0\0" "1234567890")
        self.assertTrue('Content-Type' not in self.dummy_server.request.headers)
        self.assertEqual(self.dummy_server.request.method, 'POST')
...
class ProxyNWTSUploaderTest(unittest.TestCase):
    ...
    def test_nwts_template(self):
        ...
        self.assertEqual(self.dummy_server.request.POST['-p'], '600220')
