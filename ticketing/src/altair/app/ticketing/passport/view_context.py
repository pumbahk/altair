...
def get_passport_view_context_factory(default_package):
...
def includeme(config):
    config.add_request_method(get_passport_view_context_factory(config.registry), 'view_context', reify=True)
