...
from altair.app.ticketing.cart.forms_zh_cn import ClientForm as _ClientForm
...
class ClientForm(_ClientForm):
    sex = OurRadioField(u'性别', choices=[(str(SexEnum.Male), u'男'), (str(SexEnum.Female), u'女')])
    ...
    memo = fields.TextAreaField(u"备注")
...
class ShowLotEntryForm(OurForm):
    ...
    entry_no = fields.TextField(u"抽选申请号码", validators=[v.Required()])
    tel_no = fields.TextField(u"电话号码", validators=[v.Required()])
