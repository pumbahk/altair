...
from . import api
from . import schemas
from . import forms_zh_tw
from altair.app.ticketing.cart import forms_zh_tw as cart_forms_zh_tw
from altair.app.ticketing.cart import api as cart_api
from altair.app.ticketing.users.models import SexEnum

def create_form(request, context, formdata=None, **kwds):
    """希望入力と配送先情報と追加情報入力用のフォームを返す(Chinese Tranditional)
    """
    ...
    form = forms_zh_tw.ClientForm(
        ...
        formdata=formdata,
        **kwds)
    form.country.choices = [(h, h) for h in cart_forms_zh_tw.countries]
