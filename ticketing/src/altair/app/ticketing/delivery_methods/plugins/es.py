...
def includeme(config):
    config.add_delivery_form_maker(WebCouponDeliveryFormMaker(ESWebCouponDeliveryMethodForm), u"ES")


class ESWebCouponDeliveryMethodForm(DeliveryMethodForm):
    def __init__(self, formdata=None, obj=None, prefix='', **kwargs):
        super(ESWebCouponDeliveryMethodForm, self).__init__(formdata=formdata, obj=obj, prefix=prefix, **kwargs)
