...
class PaymentGatewayCreditCardPaymentPluginTest(unittest.TestCase, CoreTestMixin, CartTestMixin):
    ...
    @mock.patch('altair.app.ticketing.payments.plugins.pgw_credit_card.pgw_api.authorize')
    @mock.patch('altair.app.ticketing.payments.plugins.pgw_credit_card.pgw_api.get_pgw_order_status')
    def test_get_auth_success(self, get_pgw_order_status, authorize):
        """ get_authの正常系テスト オーソリ成功 """
        ...
        plugin.get_auth(request, test_cart, test_user_id, test_email)
        self.assertTrue(authorize.called)

    @mock.patch('altair.app.ticketing.payments.plugins.pgw_credit_card.pgw_api.authorize')
    @mock.patch('altair.app.ticketing.payments.plugins.pgw_credit_card.pgw_api.get_pgw_order_status')
    def test_get_auth_api_error(self, get_pgw_order_status, authorize):
        """ get_authの異常系テスト オーソリ失敗 """
        from altair.app.ticketing.pgw.models import PaymentStatusEnum
        ...
        authorize.side_effect = DummyPgwAPIError(error_code=u'test_error', error_message=u'testMessage')
    ...
    @mock.patch('altair.app.ticketing.payments.plugins.pgw_credit_card.pgw_api.authorize')
    @mock.patch('altair.app.ticketing.payments.plugins.pgw_credit_card.pgw_api.get_pgw_order_status')
    def test_get_auth_point_all_use(self, get_pgw_order_status, authorize):
        """ get_authの正常系テスト 全額ポイント払いのためスキップ """
        plugin = self._getTestTarget()
        ...
        plugin.get_auth(request, test_cart, test_user_id, test_email)
        self.assertFalse(get_pgw_order_status.called)
        self.assertFalse(authorize.called)

    @mock.patch('altair.app.ticketing.payments.plugins.pgw_credit_card.pgw_api.authorize')
    @mock.patch('altair.app.ticketing.payments.plugins.pgw_credit_card.pgw_api.get_pgw_order_status')
    def test_get_auth_invalid_payment_status_type(self, get_pgw_order_status, authorize):
        """ get_authの異常系テスト 決済ステータス不正 """
        from altair.app.ticketing.pgw.models import PaymentStatusEnum
    ...
    @mock.patch('altair.app.ticketing.payments.plugins.pgw_credit_card.pgw_api.authorize')
    @mock.patch('altair.app.ticketing.payments.plugins.pgw_credit_card.pgw_api.get_pgw_order_status')
    def test_get_auth_unexpected_error(self, get_pgw_order_status, authorize):
        """ get_authの異常系テスト 決済ステータス不正 """
        from altair.app.ticketing.pgw.models import PaymentStatusEnum
        from altair.app.ticketing.payments.plugins.pgw_credit_card import PgwCardPaymentPluginFailure
        plugin = self._getTestTarget()
        ...
        authorize.side_effect = Exception()
    ...
    @mock.patch('altair.app.ticketing.payments.plugins.pgw_credit_card.pgw_api.get_pgw_order_status')
    def test_cancel_success(self, get_pgw_order_status, cancel_or_refund):
        ...
        cancel_or_refund.return_value = None
    ...
    @mock.patch('altair.app.ticketing.payments.plugins.pgw_credit_card.pgw_api.cancel_or_refund')
    @mock.patch('altair.app.ticketing.payments.plugins.pgw_credit_card.pgw_api.get_pgw_order_status')
    def test_cancel_api_error(self, get_pgw_order_status, cancel_or_refund):
        ...
        cancel_or_refund.side_effect = DummyPgwAPIError(error_code=u'test_error', error_message=u'testMessage')
    ...
    @mock.patch('altair.app.ticketing.payments.plugins.pgw_credit_card.pgw_api.cancel_or_refund')
    @mock.patch('altair.app.ticketing.payments.plugins.pgw_credit_card.pgw_api.get_pgw_order_status')
    def test_cancel_invalid_payment_status_type(self, get_pgw_order_status, cancel_or_refund):
    ...
    @mock.patch('altair.app.ticketing.payments.plugins.pgw_credit_card.pgw_api.modify')
    @mock.patch('altair.app.ticketing.payments.plugins.pgw_credit_card.pgw_api.get_pgw_order_status')
    def test_refresh_success(self, get_pgw_order_status, modify):
        ...
        get_pgw_order_status.return_value = DummyModel(
            payment_status=PaymentStatusEnum.capture.v,
            gross_amount=test_order.payment_amount + 100
        )
        modify.return_value = None
    ...
    @mock.patch('altair.app.ticketing.payments.plugins.pgw_credit_card.pgw_api.modify')
    @mock.patch('altair.app.ticketing.payments.plugins.pgw_credit_card.pgw_api.get_pgw_order_status')
    def test_refresh_failure(self, get_pgw_order_status, modify):
    ...
    @mock.patch('altair.app.ticketing.payments.plugins.pgw_credit_card.pgw_api.modify')
    @mock.patch('altair.app.ticketing.payments.plugins.pgw_credit_card.pgw_api.get_pgw_order_status')
    def test_refresh_all_point_use(self, get_pgw_order_status, modify):
    ...
    @mock.patch('altair.app.ticketing.payments.plugins.pgw_credit_card.pgw_api.modify')
    @mock.patch('altair.app.ticketing.payments.plugins.pgw_credit_card.pgw_api.get_pgw_order_status')
    def test_refresh_already_deliverd(self, get_pgw_order_status, modify):
    ...
    @mock.patch('altair.app.ticketing.payments.plugins.pgw_credit_card.pgw_api.modify')
    @mock.patch('altair.app.ticketing.payments.plugins.pgw_credit_card.pgw_api.get_pgw_order_status')
    def test_refresh_invalid_payment_status_type(self, get_pgw_order_status, modify):
    ...
    @mock.patch('altair.app.ticketing.payments.plugins.pgw_credit_card.pgw_api.modify')
    @mock.patch('altair.app.ticketing.payments.plugins.pgw_credit_card.pgw_api.get_pgw_order_status')
    def test_refresh_same_amount(self, get_pgw_order_status, modify):
        ...
        get_pgw_order_status.return_value = DummyModel(
            payment_status=PaymentStatusEnum.capture.v,
            gross_amount=test_order.payment_amount
        )
        plugin.refresh(request, test_order)
        self.assertTrue(get_pgw_order_status.called)
        self.assertFalse(modify.called)
    ...
    @mock.patch('altair.app.ticketing.payments.plugins.pgw_credit_card.pgw_api.modify')
    @mock.patch('altair.app.ticketing.payments.plugins.pgw_credit_card.pgw_api.get_pgw_order_status')
    def test_refresh_increased_amount(self, get_pgw_order_status, modify):
        """ refreshの異常系テスト 増額は許容しない """
        from altair.app.ticketing.core.models import PointUseTypeEnum
        from altair.app.ticketing.payments.plugins.pgw_credit_card import PgwCardPaymentPluginFailure
        from altair.app.ticketing.pgw.models import PaymentStatusEnum
        plugin = self._getTestTarget()
    ...
    @mock.patch('altair.app.ticketing.payments.plugins.pgw_credit_card.pgw_api.modify')
    @mock.patch('altair.app.ticketing.payments.plugins.pgw_credit_card.pgw_api.get_pgw_order_status')
    def test_refresh_changing_point_use_type(self, get_pgw_order_status, modify):
        ...
        get_pgw_order_status.return_value = DummyModel(
            payment_status=PaymentStatusEnum.capture.v,
            gross_amount=test_captured_amount
        )
        with self.assertRaises(PgwCardPaymentPluginFailure):
            plugin.refresh(request, test_order)
        self.assertTrue(get_pgw_order_status.called)
    ...
    @mock.patch('altair.app.ticketing.payments.plugins.pgw_credit_card.pgw_api.cancel_or_refund')
    @mock.patch('altair.app.ticketing.payments.plugins.pgw_credit_card.pgw_api.get_pgw_order_status')
    def test_refund_success_all_amount(self, get_pgw_order_status, cancel_or_refund):
        """ refundの正常系テスト 全額払戻 """
        from altair.app.ticketing.core.models import PointUseTypeEnum
        from altair.app.ticketing.pgw.models import PaymentStatusEnum
        plugin = self._getTestTarget()
    ...
    @mock.patch('altair.app.ticketing.payments.plugins.pgw_credit_card.pgw_api.cancel_or_refund')
    @mock.patch('altair.app.ticketing.payments.plugins.pgw_credit_card.pgw_api.get_pgw_order_status')
    def test_refund_api_error_all_amount(self, get_pgw_order_status, cancel_or_refund):
        """ refundの正常系テスト 全額払戻 """
        from altair.app.ticketing.core.models import PointUseTypeEnum
        from altair.app.ticketing.payments.plugins.pgw_credit_card import PgwCardPaymentPluginFailure, DummyPgwAPIError
        from altair.app.ticketing.pgw.models import PaymentStatusEnum
    ...
    @mock.patch('altair.app.ticketing.payments.plugins.pgw_credit_card.pgw_api.modify')
    @mock.patch('altair.app.ticketing.payments.plugins.pgw_credit_card.pgw_api.get_pgw_order_status')
    def test_refund_success_part_amount(self, get_pgw_order_status, modify):
        """ refundの正常系テスト 一部払戻 """
        from altair.app.ticketing.core.models import PointUseTypeEnum
        from altair.app.ticketing.pgw.models import PaymentStatusEnum
        plugin = self._getTestTarget()
    ...
    @mock.patch('altair.app.ticketing.payments.plugins.pgw_credit_card.pgw_api.modify')
    @mock.patch('altair.app.ticketing.payments.plugins.pgw_credit_card.pgw_api.get_pgw_order_status')
    def test_refund_api_error_part_amount(self, get_pgw_order_status, modify):
        """ refundの正常系テスト 一部払戻 """
        from altair.app.ticketing.core.models import PointUseTypeEnum
        from altair.app.ticketing.payments.plugins.pgw_credit_card import PgwCardPaymentPluginFailure, DummyPgwAPIError
        from altair.app.ticketing.pgw.models import PaymentStatusEnum
    ...
    @mock.patch('altair.app.ticketing.payments.plugins.pgw_credit_card.pgw_api.modify')
    @mock.patch('altair.app.ticketing.payments.plugins.pgw_credit_card.pgw_api.get_pgw_order_status')
    def test_refund_all_point_use(self, get_pgw_order_status, modify, cancel_or_refund):
        """ refundの正常系テスト 全額ポイント払いのためスキップ """
        from altair.app.ticketing.core.models import PointUseTypeEnum
        plugin = self._getTestTarget()
    ...
    @mock.patch('altair.app.ticketing.payments.plugins.pgw_credit_card.pgw_api.modify')
    @mock.patch('altair.app.ticketing.payments.plugins.pgw_credit_card.pgw_api.get_pgw_order_status')
    def test_refund_same_amount(self, get_pgw_order_status, modify, cancel_or_refund):
        """ refundの正常系テスト 決済金額変更なしのためスキップ """
        from altair.app.ticketing.core.models import PointUseTypeEnum
        from altair.app.ticketing.pgw.models import PaymentStatusEnum
        plugin = self._getTestTarget()
    ...
    @mock.patch('altair.app.ticketing.payments.plugins.pgw_credit_card.pgw_api.modify')
    @mock.patch('altair.app.ticketing.payments.plugins.pgw_credit_card.pgw_api.get_pgw_order_status')
    def test_refund_invalid_payment_status_type(self, get_pgw_order_status, modify, cancel_or_refund):
        """ refundの異常系のテスト 決済ステータス不正 """
        from altair.app.ticketing.core.models import PointUseTypeEnum
        from altair.app.ticketing.payments.plugins.pgw_credit_card import PgwCardPaymentPluginFailure
        from altair.app.ticketing.pgw.models import PaymentStatusEnum
        plugin = self._getTestTarget()
        ...
        get_pgw_order_status.return_value = DummyModel(
            payment_status=PaymentStatusEnum.refund.v,
            gross_amount=1000
        )
    ...
    @mock.patch('altair.app.ticketing.payments.plugins.pgw_credit_card.pgw_api.modify')
    @mock.patch('altair.app.ticketing.payments.plugins.pgw_credit_card.pgw_api.get_pgw_order_status')
    def test_refund_increased_amount(self, get_pgw_order_status, modify, cancel_or_refund):
        """ refundの異常系のテスト 増額は許容しない """
        from altair.app.ticketing.core.models import PointUseTypeEnum
        from altair.app.ticketing.payments.plugins.pgw_credit_card import PgwCardPaymentPluginFailure
        from altair.app.ticketing.pgw.models import PaymentStatusEnum
        plugin = self._getTestTarget()
