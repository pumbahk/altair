...
from altair.app.ticketing.oauth2.consts import CLIENT_KEY_LENGTH, CLIENT_SECRET_LENGTH,\
...
from altair.app.ticketing.models import WithTimestamp, Identifier, relationship
