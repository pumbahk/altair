...
from altair.app.ticketing.oauth2.authorize import Authorizer
...
def _setup_db():
    ...
    from altair.app.ticketing.operators.models import Operator, Permission, OperatorRole
    from altair.app.ticketing.core.models import Organization, User
    from altair.app.ticketing.oauth2.models import Service, AccessToken
...
def setup_database():
    ...
    from altair.app.ticketing.seed.user import UserData
    from altair.app.ticketing.seed.bank import BankAccountData, BankData
...
class AccessTokenTest(unittest.TestCase):
    ...
    def test_auth(self):
        ...
        from altair.app.ticketing.oauth2.models import AccessToken
