...
if (window.ActiveXObject) {
  ...
  Drawable.prototype.path = function Drawable_path(pathData) {
    ...
    path.setAttribute(''path'', buf.join('' 11 ''));
  ...
  Drawable.prototype.initialize = function Drawable_initialize(n, width, height) {
    ...
    svg.setAttribute(''viewBox'', ''0 0 '' + parseFloat(width) + '' 22 '' + parseFloat(height));
  ...
  Drawable.prototype.path = function Drawable_path(pathData) {
    ...
    path.setAttribute(''d'', buf.join('' 33 ''));
