...
INSERT INTO `FamiPortTicketTemplate` VALUES (NULL,'TTTSTR0001',0,'[[\"TitleOver\", \"{{{イベント名}}}\"],[\"TitleMain\", \"{{{パフォーマンス名}}}\"],[\"TitleSub\", \"{{{公演名副題}}}\"],[\"FreeSpace1\", \"{{{aux.FreeSpace1}}}\"],[\"FreeSpace2\", \"{{{aux.FreeSpace2}}}\"],[\"Date\", \"{{{開催日c}}}\"],[\"OpenTime\", \"{{{開場時刻c}}}\"],[\"StartTime\", \"{{{開始時刻c}}}\"],[\"Price\", \"{{{チケット価格}}}\"],[\"Hall\", \"{{{会場名}}}\"],[\"Note1\", \"{{{aux.注意事項1}}}\"],[\"Note2\", \"{{{aux.注意事項2}}}\"],[\"Note3\", \"{{{aux.注意事項3}}}\"],[\"Note4\", \"{{{aux.注意事項4}}}\"],[\"Note5\", \"{{{aux.注意事項5}}}\"],[\"Note6\", \"{{{aux.注意事項6}}}\"],[\"Note7\", \"{{{aux.注意事項7}}}\"],[\"Seat1\", \"{{{席種名}}}\"],[\"Seat2\", \"{{{席番}}}\"],[\"Seat3\", \"{{{aux.Seat3}}}\"],[\"Seat4\", \"{{{aux.Seat4}}}\"],[\"Seat5\", \"{{{aux.Seat5}}}\"],[\"Sub-Title1\", \"{{{イベント名}}}\"],[\"Sub-Title2\", \"{{{パフォーマンス名}}}\"],[\"Sub-Title3\", \"{{{公演名副題}}}\"],[\"Sub-Title4\", \"{{{aux.Sub-Title4}}}\"],[\"Sub-Title5\", \"{{{aux.Sub-Title5}}}\"],[\"Sub-Date\", \"{{{開催日c}}}\"],[\"Sub-OpenTime\", \"{{{開場時刻s}}}\"],[\"Sub-StartTime\", \"{{{開始時刻s}}}\"],[\"Sub-Price\", \"{{{チケット価格}}}\"],[\"Sub-Seat1\", \"{{{席種名}}}\"],[\"Sub-Seat2\", \"{{{席番}}}\"],[\"Sub-Seat3\", \"{{{aux.Sub-Seat3}}}\"],[\"Sub-Seat4\", \"{{{aux.Sub-Seat4}}}\"],[\"Sub-Seat5\", \"{{{aux.Sub-Seat5}}}\"]]',15,'TTTSTR0001',NULL);
INSERT INTO `FamiPortTicketTemplate` VALUES (NULL,'TTTSTR0002',0,'[[\"TitleMain\", \"{{{イベント名}}}\"],[\"TitleSub\", \"{{{パフォーマンス名}}}\"],[\"Restrictions\", \"{{{公演名備考}}}\"],[\"DetailNote\", \"{{{aux.注意事項1}}}{{{aux.注意事項2}}}{{{aux.注意事項3}}}{{{aux.注意事項4}}}{{{aux.注意事項5}}}{{{aux.注意事項6}}}{{{aux.注意事項7}}}{{{aux.注意事項8}}}{{{aux.注意事項9}}}{{{aux.注意事項10}}}{{{aux.注意事項11}}}\"],[\"DetailFree\", \"{{{予約時補助文言1}}}\"],[\"SeatTicket\", \"{{{席種名}}}　{{{席番}}}\"],[\"Price\", \"{{{チケット価格}}}\"],[\"Inquiry\", \"{{{aux.お問い合わせ先}}}\"],[\"Sub-TitleMain\", \"{{{パフォーマンス名}}}\"],[\"Sub-DetailFree\", \"{{{公演名備考}}}\"],[\"Sub-Abbreviation\", \"{{{イベント名略称}}}\"],[\"Sub-Seat\", \"{{{席種名}}}\"],[\"Sub-Ticket\", \"{{{席番}}}\"],[\"Sub-Price\", \"{{{チケット価格}}}\"]]',15,'TTTSTR0002',NULL);
INSERT INTO `FamiPortTicketTemplate` VALUES (NULL,'TTTSTR0003',1,'[[\"TitleMain\", \"{{{aux.副券名}}}\"],[\"Free\", \"{{{aux.注意事項1}}}{{{aux.注意事項2}}}{{{aux.注意事項3}}}{{{aux.注意事項4}}}{{{aux.注意事項5}}}{{{aux.注意事項6}}}{{{aux.注意事項7}}}{{{aux.注意事項8}}}{{{aux.注意事項9}}}{{{aux.注意事項10}}}{{{aux.注意事項11}}}{{{aux.注意事項12}}}{{{aux.注意事項13}}}{{{aux.注意事項14}}}{{{aux.注意事項15}}}{{{aux.注意事項16}}}{{{aux.注意事項17}}}\"],[\"Sub-Free\", \"{{{aux.注意事項18}}}{{{aux.注意事項19}}}{{{aux.注意事項20}}}{{{aux.注意事項21}}}{{{aux.注意事項22}}}{{{aux.注意事項23}}}{{{aux.注意事項24}}}{{{aux.注意事項25}}}{{{aux.注意事項26}}}{{{aux.注意事項27}}}{{{aux.注意事項28}}}{{{aux.注意事項29}}}\"]]',15,'TTTSTR0003',NULL);
...
-- ticketing@dbmain.standby.altrからorganization_id = 15 の条件でFamiPortTicketTemplateをdumpしてidをNULLに書き換えたもの