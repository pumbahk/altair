...
INSERT INTO `FamiPortTicketTemplate` VALUES (NULL,'TTTSTR0002',0,'[[\"TitleMain\", \"{{{イベント名}}}\"],[\"TitleSub\", \"{{{パフォーマンス名}}}\"],[\"Restrictions\", \"{{{公演名備考}}}\"],[\"DetailNote\", \"{{{aux.注意事項1}}}{{{aux.注意事項2}}}{{{aux.注意事項3}}}{{{aux.注意事項4}}}{{{aux.注意事項5}}}{{{aux.注意事項6}}}{{{aux.注意事項7}}}{{{aux.注意事項8}}}{{{aux.注意事項9}}}{{{aux.注意事項10}}}{{{aux.注意事項11}}}\"],[\"DetailFree\", \"{{{予約時補助文言1}}}\"],[\"SeatTicket\", \"{{{席種名}}}　{{{席番}}}\"],[\"Price\", \"{{{チケット価格}}}\"],[\"Inquiry\", \"{{{aux.お問い合わせ先}}}\"],[\"Sub-TitleMain\", \"{{{パフォーマンス名}}}\"],[\"Sub-DetailFree\", \"{{{公演名備考}}}\"],[\"Sub-Abbreviation\", \"{{{イベント名略称}}}\"],[\"Sub-Seat\", \"{{{席種名}}}\"],[\"Sub-Ticket\", \"{{{席番}}}\"],[\"Sub-Price\", \"{{{チケット価格}}}\"]]',56,'TTTSTR0002',NULL);
INSERT INTO `FamiPortTicketTemplate` VALUES (NULL,'TTTSTR0003',1,'[[\"TitleMain\", \"{{{aux.副券名}}}\"],[\"Free\", \"{{{aux.注意事項1}}}{{{aux.注意事項2}}}{{{aux.注意事項3}}}{{{aux.注意事項4}}}{{{aux.注意事項5}}}{{{aux.注意事項6}}}{{{aux.注意事項7}}}{{{aux.注意事項8}}}{{{aux.注意事項9}}}{{{aux.注意事項10}}}{{{aux.注意事項11}}}{{{aux.注意事項12}}}{{{aux.注意事項13}}}{{{aux.注意事項14}}}{{{aux.注意事項15}}}{{{aux.注意事項16}}}{{{aux.注意事項17}}}\"],[\"Sub-Free\", \"{{{aux.注意事項18}}}{{{aux.注意事項19}}}{{{aux.注意事項20}}}{{{aux.注意事項21}}}{{{aux.注意事項22}}}{{{aux.注意事項23}}}{{{aux.注意事項24}}}{{{aux.注意事項25}}}{{{aux.注意事項26}}}{{{aux.注意事項27}}}{{{aux.注意事項28}}}{{{aux.注意事項29}}}\"]]',56,'TTTSTR0003',NULL);
