...
def upgrade():
    ...
    op.add_column(u"TicketPrintHistory", sa.Column("item_token_id",  Identifier, nullable=True)),
...
def downgrade():
    op.drop_constraint('TicketPrintHistory_ibfk_5', 'TicketPrintHistory', type='foreignkey')
    op.drop_column("TicketPrintHistory", "item_token_id")
