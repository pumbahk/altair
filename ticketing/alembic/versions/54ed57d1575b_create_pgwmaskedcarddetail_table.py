...
def upgrade():
    op.create_table('PGWMaskedCardDetail',
                    ...
                    sa.Column('card_last4digits', sa.Unicode(length=4), nullable=False),
                    sa.Column('card_expiration_month', sa.Unicode(length=2), nullable=False),
                    sa.Column('card_expiration_year', sa.Unicode(length=4), nullable=False),
