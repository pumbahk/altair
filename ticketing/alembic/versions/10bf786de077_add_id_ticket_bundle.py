...
def upgrade():
    ...
    op.execute("ALTER TABLE TicketBundleAttribute DROP FOREIGN KEY TicketBundleAttribute_ibfk_1;")
    ...
    op.execute("ALTER TABLE TicketBundleAttribute ADD CONSTRAINT TicketBundleAttribute_ibfk_1 FOREIGN KEY (ticket_bundle_id) REFERENCES TicketBundle (id) ON DELETE CASCADE")
