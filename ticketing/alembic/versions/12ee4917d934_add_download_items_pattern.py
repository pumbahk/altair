"""add download items pattern

Revision ID: 12ee4917d934
Revises: 31d1cabf1a08
Create Date: 2016-11-14 10:12:37.718151

"""

# revision identifiers, used by Alembic.
revision = '12ee4917d934'
...
def upgrade():
    op.create_table('DownloadItemsPattern',
        ...
        sa.Column('updated_at', sa.TIMESTAMP(), server_default=sqlf.current_timestamp(), nullable=False),
        sa.PrimaryKeyConstraint('id'),
        sa.ForeignKeyConstraint(['organization_id'], ['Organization.id'], 'downloaditemspattern_ibfk_1', ondelete='CASCADE'),
