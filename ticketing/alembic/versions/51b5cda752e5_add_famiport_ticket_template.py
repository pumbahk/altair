...
def upgrade():
    ...
    op.execute(u'''INSERT INTO FamiPortTicketTemplate (template_code, logically_subticket, mappings) VALUES ('TTTSTR0001', FALSE, '[["TitleOver", "{{{イベント名}}}"], ["TitleMain", "{{{パフォーマンス名}}}"], ["TitleSub", "{{{公演名副題}}}"], ["Date", "{{{開催日}}}"], ["OpenTime", "{{{開場時刻}}}"], ["StartTime", "{{{開始時刻}}}"], ["Price", "{{{チケット価格}}}"], ["Hall", "{{{会場名}}}"], ["Note1", "{{{aux.注意事項1}}}"], ["Note2", "{{{aux.注意事項2}}}"], ["Note3", "{{{aux.注意事項3}}}"], ["Note4", "{{{aux.注意事項4}}}"], ["Note5", "{{{aux.注意事項5}}}"], ["Note6", "{{{aux.注意事項6}}}"], ["Note7", "{{{aux.注意事項7}}}"], ["Seat1", "{{{券種名}}}"], ["Sub-Title1", "{{{イベント名}}}"], ["Sub-Title2", "{{{パフォーマンス名}}}"], ["Sub-Title3", "{{{公演名副題}}}"], ["Sub-Date", "{{{開催日s}}}"], ["Sub-OpenTime", "{{{開場時刻s}}}"], ["Sub-StartTime", "{{{開始時刻s}}}"], ["Sub-Price", "{{{チケット価格}}}"], ["Sub-Seat1", "{{{券種名}}}"]]')''')
