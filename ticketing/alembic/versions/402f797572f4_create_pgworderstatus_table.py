...
def upgrade():
    op.create_table('PGWOrderStatus',
                    ...
                    sa.Column('enrolled_at', sa.DateTime(), index=True, nullable=False),
                    sa.Column('authed_at', sa.DateTime(), index=True, nullable=False),
                    sa.Column('captured_at', sa.DateTime(), index=True, nullable=False),
                    sa.Column('canceled_at', sa.DateTime(), index=True, nullable=False),
                    sa.Column('refunded_at', sa.DateTime(), index=True, nullable=False),
                    sa.Column('payment_status', TINYINT, index=True, nullable=False),
