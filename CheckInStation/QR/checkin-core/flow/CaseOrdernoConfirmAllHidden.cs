...
namespace checkin.core.flow
{
    ...
    /// </summary>
    // 
    public class CaseOrdernoConfirmForAllHidden : AbstractCase, ICase
    {
        ...
        public CaseOrdernoConfirmForAllHidden(IResource resource, VerifiedOrdernoRequestData requestData)
            : base(resource)
        {
        ...
        public CaseOrdernoConfirmForAllHidden(IResource resource, VerifiedOrdernoRequestData requestData, int partorall)
            : base(resource)
        {
            this.RequestData = requestData;
            this.tokenStatus = TokenStatus.valid;
