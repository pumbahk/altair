...
<!-- InstanceEndEditable -->
	...
	<div id ="main">
	 <ul> <?  $genre = genre_get_by_name($dbh, $genre_name);
			...
			$link .= $parent_link[$i].'/';
			?>
<a href="/~katosaori/mock/pages/genre.php?genre=<?= $link ?>"><?= htmlspecialchars($parent_link[$i])?></a>
<? echo "/";
        }
...
?>
                   ...
                   <li><a href="/~katosaori/mock/pages/genre.php?genre=<?=$genre_link?>"><?= htmlspecialchars($genre['genre'])?></a></li>
...
?>
	...
	<?php
		...
		for($u=0;$u<=$count_genre_names;$u++){
			$link .= $genre_names[$u].'/'; 
			?>
		<a href="/~katosaori/mock/pages/genre.php?genre=<?=$link?>"><?= htmlspecialchars($genre_names[$u])?></a>
		<?
	}
?>
	<?
                        ...
                        ?>
                                 <li><a href="/~katosaori/mock/pages/cdshousai.php?artist=<?=$artist_link?>"><?= htmlspecialchars($artists[$e]['name'])?></a></li>
                <?
                        }
                }
