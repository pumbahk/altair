...
$img = "new";for($i=0;$i<=9;$i++){
        for($e=0;$e<=9;$e++){
        	if(isset($old_rank_array[$e]['itemname'])&&isset($new_rank_array[$e]['itemname'])){
...
for($i=0;$i<=9;$i++){
        for($e=0;$e<=9;$e++){
        	if(isset($old_rank_overseas_array[$e]['itemname'])&&isset($new_rank_overseas_array[$e]['itemname'])){
