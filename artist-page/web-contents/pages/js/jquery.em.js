 ...
 *
 * Copyright ﾂｩ2007 Dave Cardwell <http://davecardwell.co.uk/>
 *
 * Released under the MIT licence:
 * http://www.opensource.org/licenses/mit-license.php
 */

// Upon $(document).ready()窶ｦ
jQuery(function($) {
    // Configuration窶ｦ
    ...
    $.em = $.extend({
         ...
         * @desc The default action is to trigger a global 窶彳mchange窶 event.
         * You probably shouldn窶冲 change this behaviour as other plugins may
        ...
        action: function() {
            ...
            // If the font size has changed since we last checked窶ｦ
            if ( currentWidth != $.em.current ) {
                /**
                 * The previous pixel value of the user agent窶冱 font size. See
                 * $.em.current for caveats. Will initially be undefined until
                 * the 窶彳mchange窶 event is triggered.
                 *
                 * @example $.em.previous;
                 * @result 16
                 *
                ...
                /**
                 * The current pixel value of the user agent窶冱 font size. As
    ...
    // Store the initial pixel value of the user agent窶冱 font size.
