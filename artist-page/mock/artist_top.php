...
<li><div id ="imgs">
		...
		<div id ="tokushu">
			...
			<!--<div id ="rankin_all">
				...
				<div id ="rankin_list">
					<ul>
				<li id ="#"><a href ="jyannru.html">片想いFinally　　　　　　　　　SKE48</a></li>
				<li id ="#"><a href ="jyannru.html">ナイショの話　　　　　　　　　　ClariS</a></li>
				<li id ="#"><a href ="jyannru.html">ひとつ　　　　　　　　　　　　　長渕剛</a></li>
				<li id ="#"><a href ="jyannru.html">ワールド　　　　　　　　　　　 CNBLUE</a></li>
				<li id ="#"><a href ="jyannru.html">Where you are　　　　　　　　SuG</a></li>
				<li id ="#"><a href ="jyannru.html">ロック　　　　　　　　　　　　 スマイレージ</a></li>
				<li id ="#"><a href ="jyannru.html">チョトマテクダサイ！　　　　　スマイレージ</a></li>
				<li id ="#"><a href ="jyannru.html">ダンス.ハウス　　　　　　　　　azuma</a></li>
				<li id ="#"><a href ="jyannru.html">満月に吠えろ　　　　　　　　　チャットモンチー</a></li>
				<li id ="#"><a href ="jyannru.html">いのちの歌　　　　　　　　　　竹内まりや</a></li>
				<li id ="#"><a href ="jyannru.html">クラシック邦　　　　　　　　　川田真美</a></li>
				<li id ="#"><a href ="jyannru.html">Serment　　　　　　　　　　　JUJU</a></li>
				</ul>	
			</div>
			<center>10位以下</center>
		</div>-->
