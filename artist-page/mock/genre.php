...
foreach ($genre['tree'] as $idx => $tree_genre) {
	...
	if ($idx) print '&gt;';
?>
<a href="/~katosaori/altair-mock/genre.php?genre=<?=$genre_link?>"><?=$tree_genre ?></a>
<?
}
...
?>
	<a href="/~katosaori/altair-mock/genre.php?genre=<?=$genre_link?>"><?= htmlspecialchars($genre['genre'])?></a><br>	
<? echo $genre['id'];?>	
<?
}
