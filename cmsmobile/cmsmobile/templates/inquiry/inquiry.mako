...
<body>
    ...
    <form action="/inquiry" method="POST">
        <fieldset>
            <div style="font-size: x-small">
                ${h.form_item(form.name, style="font-size: x-small")}<p/>
                ${h.form_item(form.mail, style="font-size: x-small")}<p/>
                ${h.form_item(form.num, style="font-size: x-small")}
                <div style="font-size: x-small">予約受付番号をお持ちの場合入力してください。</div>
                ${h.form_item(form.category, style="font-size: x-small")}<p/>
                ${h.form_item(form.title, style="font-size: x-small")}<p/>
                ${h.form_item(form.body, style="font-size: x-small")}<p/>
            </div>
        </fieldset>
